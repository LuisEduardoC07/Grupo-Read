describe('Validar navegación entre páginas.', () => {
  it('Verificar que se puede navegar entre las diferentes páginas de la aplicación', () => {
    ...
    //Paso 4: hacer click en un boton "x" que te lleve a otra pagina
